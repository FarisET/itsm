...
class _LogPageState extends State<LogPage> {
  ...
  // Track expanded rows by AssetLog ID
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          _buildColumnVisibilityDropdown(),
        ],
      ),
      body: Padding(
  ...
  List<DataColumn> _buildDataColumns() {
    ...
    if (columnVisibility['User']!) {
      columns.add(DataColumn(label: Text('User')));
    }
  ...
  List<DataCell> _buildDataCells(AssetLog log) {
    ...
    if (columnVisibility['User']!) {
      cells.add(DataCell(Text(log.actionUser)));
    }

    return cells;
  }

  // Builds a cell with expandable Action text
