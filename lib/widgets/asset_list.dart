...
// import 'package:safify/widgets/view_asset_tile.dart';
...
//     return Center(child:
//         Consumer<AssetProviderClass>(builder: (context, assetProvider, _) {
//       if (assetProvider.error != null &&
//           assetProvider.error!.contains('TokenExpiredException')) {
//         if (assetProvider.error!.contains('TokenExpiredException')) {
...
//           itemCount: assetProvider.assetTypeList.length,
//           itemBuilder: (context, i) {
//             var item = assetProvider.assetTypeList[i];

//             return ViewAssettTile(asset: item);
//           },
//         );
